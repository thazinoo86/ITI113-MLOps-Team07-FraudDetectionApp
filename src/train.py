...
train_dataset = pd.read_csv(os.path.join(args.train, "train.csv"))
test_dataset = pd.read_csv(os.path.join(args.test, "test.csv"))
X_train = train_dataset.drop(columns=[label_column]).to_numpy()
y_train = train_dataset[label_column].to_numpy()
X_test = test_dataset.drop(columns=[label_column]).to_numpy()
y_test = test_dataset[label_column].to_numpy()
